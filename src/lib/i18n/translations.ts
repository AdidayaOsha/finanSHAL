...
const translations = {
  en: {
    ...
    setBudget: {
      button: "Set Budget",
      modalTitle: "Set Monthly Budget",
      category: "Category",
      limit: "Monthly Limit (IDR)",
      saving: "Saving...",
      save: "Save Budget",
    },
    join: {
      title: "Family Invite",
      joining: "Joining family group...",
      success: "You've joined the family!",
      successDesc: "You're now part of the family group.",
  ...
  id: {
    ...
    setBudget: {
      ...
      modalTitle: "Atur Anggaran Bulanan",
      category: "Kategori",
      limit: "Batas Bulanan (IDR)",
      saving: "Menyimpan...",
      save: "Simpan Anggaran",
    },
    join: {
      title: "Undangan Keluarga",
      joining: "Bergabung ke grup keluarga...",
      success: "Kamu sudah bergabung!",
      successDesc: "Kamu sekarang bagian dari grup keluarga.",
      error: "Link undangan ini tidak valid atau sudah kadaluarsa.",
